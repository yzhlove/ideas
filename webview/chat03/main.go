...
var (
	csv1 = `ID	OnceTicket	OnceDiamond	TenTimes	TenTimesDiamond	LimitCount	ATypeProb	BTypeProb	PRDCount	PRDProb	ATypeCount	GuaranteePkgId	TargetCount	TargetPkgId	ATypePkg	BTypePkg	CTypePkg	ATypeUpProb	BTypeUpProb	StorageId	ExtraPkgId	GuranteeSR	StartTime	EndTime
...
`
	csv2 = `ID	OnceTicket	OnceDiamond	TenTimesTicket	TenTimesDiamond	LimitCount	ATypeProb	BTypeProb	PRDTimes	AbCProb	ATypeFirstCount	ATypeCount	GuaranteePkgId	TargetCount	TargetPkgId	ATypePkg	BTypePkg	CTypePkg	ATypeUpProb	BTypeUpProb	StorageId	ExtraPkgId	GuranteeSR	StartTime	EndTime
1	null	300	null	3000	999	200	1500	51	50	20	100	10009	3	10008	10001	10002	10003	5000	0	1	10099	10006		
